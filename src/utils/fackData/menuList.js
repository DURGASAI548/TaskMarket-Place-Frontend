...
//  Each menu (and submenu) declares which userTypes can see it
//  via a `roles` array. If `roles` is omitted, the item is
//  visible to everyone.
//
//  Roles in this app:
//    - superAdmin   → sees everything
//    - orgAdmin     → sees everything
//    - branchAdmin  → sees everything except Organizations
//    - user         → sees only Tasks → View Tasks
//
//  To change "user" visibility (e.g. let users see Tags too),
//  just add 'user' to that item's `roles` array.
// ─────────────────────────────────────────────────────────────
...
export const menuList = [
    ...
    },
    {
        ...
        path: "#",
        icon: 'feather-users',
        roles: ['superAdmin', 'orgAdmin', 'branchAdmin', 'user'],
        dropdownMenu: [
            {
                id: 1,
                name: "View Tasks",
